...
> **⚠️ Superseded note:** this file predates the deployed pipeline described
> in `README.md`. The real Databricks setup today uses a **Unity Catalog
> Volume** (`rankrangers_project_data.pdf.cet_raw_pdfs`, see `README.md` §9)
> — **not** the legacy `dbutils.fs.mount()` steps below. Keep this file for
> **local / Colab / Kaggle** setup, which is still accurate; for Databricks,
> follow `README.md` instead.
