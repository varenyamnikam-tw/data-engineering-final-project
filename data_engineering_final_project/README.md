...
The 'data_engineering_final_project' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/data_engineering_final_project/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] data_engineering_final_project_etl` to your workspace.
